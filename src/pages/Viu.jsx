    ...
    return (
        <div className="viu-page">
            ...
            <section className="viu-content-section">
                ...
                <span className="viu-section-count">{currentContent.length} titles</span>
                <div className="viu-grid">
                    {currentContent.map(item => (<MovieCard key={item.id} item={item} onClick={() => handleItemClick(item)} />))}
                </div>
                {currentPage < totalPages && (
                    <div className="load-more-container">
                        <button className="load-more-btn viu-load-more" onClick={loadMore} disabled={isLoadingMore}>
