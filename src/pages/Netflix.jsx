...
const Netflix = () => {
    ...
    // Update URL when filters change (replace instead of push to avoid polluting history)
    useEffect(() => {
    ...
    // Filter and sort TV shows based on current filters
    ...
    const handleApplyFilters = (newFilters) => {
        ...
        if (newFilters.year) {
            newFilterState.year = parseInt(newFilters.year);
        }

        if (newFilters.rating) {
            newFilterState['vote_average.gte'] = parseFloat(newFilters.rating);
        }
        ...
        <div className="netflix-page">
            ...
            <section className="netflix-section">
                <div className="netflix-section-header">
                    ...
                    <span className="netflix-section-count">{filteredMovies.length} titles</span>
                    <button
            ...
            <section className="netflix-section">
                <div className="netflix-section-header">
                    ...
                    <span className="netflix-section-count">{filteredTVShows.length} titles</span>
                </div>
                <div className="netflix-grid">
