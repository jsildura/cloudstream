// PopularTV.jsx - Popular TV Shows Page
...
const PopularTV = () => {
    ...
    const fetchBannerShows = async () => {
        try {
            const res = await fetch('/api/tv/popular?page=1');
            if (res.ok) {
            ...
            console.error('Failed to fetch popular TV shows for banner:', error);
        }
    };
        ...
        <div className="movies-page">
            ...
            <div className="page-title-section" style={{
                ...
                <p style={{
                    ...
                    width: '100%',
                    lineHeight: '1.5'
                }}>Discover the most popular TV shows worldwide. These are the series everyone is watching right now.</p>
            </div>
