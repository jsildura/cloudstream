...
const ReviewSection = memo(({ contentId, type, voteAverage, voteCount }) => {
    ...
    return (
        <div className={`review-section ${isCollapsed ? 'collapsed' : ''}`}>
            <div
            ...
            >
                <div className="review-section-header-left">
                ...
                >
                    <svg
                        className={`review-toggle-icon ${isCollapsed ? 'is-collapsed' : ''}`}
                        width="18"
                        height="18"
                        viewBox="0 0 24 24"
                        fill="none"
            ...
            {!isCollapsed && (
                <div id="review-section-content" className="review-section-content">
