 ...
 * @param {object} disabled - Object indicating which toggles are disabled, e.g. { movie: false, tv: true }
 */
const MediaTypeToggle = ({ activeType, onToggle, disabled = {} }) => {
    return (
        <div className="media-type-toggle">
            ...
            <button
                ...
                disabled={disabled.tv}
                aria-disabled={disabled.tv}
            >
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
